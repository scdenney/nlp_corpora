...
This corpus contains 483 poems by five canonical modern Korean poets, annotated with fine-grained emotion labels by five human annotators using the 44-category KOTE (Korean Online Text Emotions) framework. The dataset is provided at two levels of granularity: individual verse lines (7,007 entries) and full poems (615 entries).

The five poets span the colonial and post-liberation periods of Korean literary history:

| Poet | Korean | Period | Poems | Lines |
|------|--------|--------|-------|-------|
| Yun Dong-ju (윤동주) | 윤동주 | 1917–1945 | 114 | 1,111 |
| Kim So-wol (김소월) | 김소월 | 1902–1934 | 176 | 2,071 |
| Han Yong-un (한용운) | 한용운 | 1879–1944 | 138 | 1,198 |
| Im Hwa (임화) | 임화 | 1908–1953 | 110 | 2,163 |
| Yi Sang (이상) | 이상 | 1910–1937 | 77 | 464 |
...
- **kpoem_poems.tsv** — Poem-level annotations (615 rows). Each row is a full poem with emotion annotations.
